...
chrome.storage.local.get({ 'clearCodeOptions': { theme_options: { css_theme: 'default.css' }}}, function (response) {
  css_link.href = 'highlight/styles/' + response.clearCodeOptions.theme_options.css_theme;
...
chrome.storage.onChanged.addListener(function(changes, namespace) {
  ...
  css_link.href = 'highlight/styles/' + changes.clearCodeOptions.newValue.theme_options.css_theme;
